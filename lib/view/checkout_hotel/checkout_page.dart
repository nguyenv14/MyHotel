...
import 'package:my_hotel/model/date_model.dart';
...
import 'package:my_hotel/view/checkout_hotel/componets/alert_dialog_coupon.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OrderViewModel>(
      builder: (context, value, child) {
        ...
        if (orderViewModel.orderModelResponse.status == Status.completed) {
